...
class AssassinClassSword extends TieredTool {
	
	public function __construct(int $id = 417, int $meta = 0) {
		
		parent::__construct($id, $meta, "Assassin Class Sword", TieredTool::TIER_DIAMOND);
	}
